Scriptname bind_PrologueInspectionQuestScript extends Quest  
...
event OnInit()
    ...
    if self.IsRunning()
        ...
        ;debug.MessageBox("inspection pro started...")
...
event SafewordEvent()
    bind_Utility.WriteToConsole("prologue inspection quest safeword ending")
    self.Stop()
endevent
...
function StartTheQuest() ;NOTE - this is called from the blocking dialog in the quest
    ...
    bind_EventInspectionQuest.Start()
...
Quest property bind_EventInspectionQuest auto